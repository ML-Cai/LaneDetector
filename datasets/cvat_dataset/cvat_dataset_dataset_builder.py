...
class Builder(tfds.core.GeneratorBasedBuilder):
  ...
  def _info(self) -> tfds.core.DatasetInfo:
    ...
    # TODO(cvat_dataset): Specifies the tfds.core.DatasetInfo object
    return self.dataset_info_from_configs(
        ...
        features=tfds.features.FeaturesDict({
            ...
            "label": tfds.features.Sequence(tfds.features.Tensor(shape=(None, None), dtype=tf.float32, encoding="bytes")),
  ...
  def _split_generators(self, dl_manager: tfds.download.DownloadManager):
    ...
    # TODO(cvat_dataset): Downloads the data and defines the splits
    # path = dl_manager.download_and_extract('https://todo-data-url')
    path = "/mnt/c/Users/inf21034/source/IMG_ROOTS/1280x960_CVATROOT/"
    # TODO(cvat_dataset): Returns the Dict[split names, Iterator[Key, Example]]
    return {
  ...
  def _generate_examples(self, path, label_data_name, augmentation_deg):
    ...
    global cnt_unique
    with open("/mnt/c/Users/inf21034/PycharmProjects/edge_tpu_lane_detection/add_ins/cvat_config2.json") as json_file:
